...
from vnpy_pro.data.tdx.tdx_common import (
    lru_cache,
    TDX_FUTURE_HOSTS,
    PERIOD_MAPPING,
...
NUM_MINUTE_MAPPING: Dict[str, int] = {'1min': 1, '5min': 5, '15min': 15, '30min': 30, '1hour': 60, '1day': 60 * 24,
                                      '1week': 60 * 24 * 7, '1month': 60 * 24 * 7 * 30}

Tdx_Vn_Exchange_Map = {'47': Exchange.CFFEX, '28': Exchange.CZCE, '29': Exchange.DCE, '30': Exchange.SHFE}
